...
const page = () => {
  ...
  return (
    <div>
      ...
      <div className="container flex flex-col items-center justify-center py-32">
        <div className="w-full lg:w-[1024px] text-start ">
      ...
      <div className="flex flex-col gap-16">
      {
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16" >
          ...
          <div className="flex flex-col justify-center gap-5 w-full lg:w-[560px]">
            <span className="text-purple">{item.category.name}</span>
            <h2>{item.title}</h2>
            <p>{item.content}</p>
